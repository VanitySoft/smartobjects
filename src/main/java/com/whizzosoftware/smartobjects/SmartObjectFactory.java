...
public class SmartObjectFactory {
    public static SmartObject newObjectInstance(int id, int instanceId) throws InvalidObjectException {
        try {
            switch (id) {
                ...
                default:
                    throw new InvalidObjectException("Unknown object ID: " + id);
            }
        } catch (InvalidResourceException e) {
            throw new InvalidObjectException("Unable to create object with ID: " + id, e);
        }
    }
}
